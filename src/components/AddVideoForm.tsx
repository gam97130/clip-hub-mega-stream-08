...
const AddVideoForm: React.FC<AddVideoFormProps> = ({ onAddVideo }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onAddVideo({
      ...
      thumbnail,
      category,
      ...(seriesId && seriesId !== "none" && { seriesId }),
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="bg-clip-gray border-clip-lightGray text-white sm:max-w-[500px] max-h-[90vh]">
        <DialogHeader>
        ...
        <ScrollArea className="max-h-[calc(90vh-15rem)] pr-4">
