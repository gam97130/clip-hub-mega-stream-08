...
import { filterVideosByCategory, getCategories } from '../utils/videoStorage';
...
const VideoList: React.FC<VideoListProps> = ({ videos, onSelectVideo }) => {
  ...
  const filteredVideos = filterVideosByCategory(videos, activeCategory);
    ...
    <div className="space-y-6 animate-slide-up">
      ...
      {filteredVideos.length === 0 ? (
        <div className="flex flex-col items-center justify-center p-8 bg-clip-gray rounded-lg border border-clip-lightGray">
          <p className="text-gray-400 mb-4">Aucune vidéo dans cette catégorie</p>
        </div>
      ) : (
